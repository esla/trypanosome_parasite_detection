...
def get_train_args_parser(add_help=True):
    ...
    # parser.add_argument("--train-images-dir", type=str, help="root directory of the training images path")
    # parser.add_argument("--val-images-dir", type=str, help="root directory of the validation images path")
    # parser.add_argument("--test-images-dir", type=str, help="root directory of the test images path")
    # parser.add_argument("--train-json-file", type=str, help="coco json file containing the training dataset")
    # parser.add_argument("--val-json-file", type=str, help="coco json file containing the validation dataset")
    # parser.add_argument("--test-json-file", type=str, help="coco json file containing the test dataset")
    # parser.add_argument("--num-classes", default=2, type=int, help="number of classes in the dataset")
    # parser.add_argument("--dataset", default="coco", type=str, help="dataset name")
    # parser.add_argument("--partition", default="val", type=str, help="dataset partition (val/test)")
    ...
    #     action="store_true",
    # )
    # parser.add_argument("--tensorboard-rootdir", type=str, help="root dir to save the tensorboard log outputs")
    #
    # parser.add_argument(
    ...
    # parser.add_argument("--result-coco-file", default=None, type=str, help="coco file name to save the predictions to")
    #
